...
Un style architectural est un ensemble de contraintes placées sur une architecture logicielle c'est à dire une abstraction décrivant les processus, les connecteurs, ainsi que les données présents au sein d'un système <<soft-archi>>.
