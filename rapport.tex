...
Apache camel est un framework implémentant un ensemble de patterns
d'intégration décrit dans l'ouvrage « Enterprise Integration Patterns »
\cite{hohpe2003enterprise}.

Une solution intéressante proposé par ce framework est le langage
spécifique REST transposable à la fois en Java et en XML.
