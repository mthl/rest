...
\verb=dev@ofbiz.apache.org= et de revue de codes sur le gestionnaire
de ticket
JIRA\footnote{\url{https://issues.apache.org/jira/projects/OFBIZ}}. En cela
le mode de développement de ce stage est agile dans la mesure les
