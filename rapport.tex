...
\tikzumlset{fill class=black!2.5, fill component=white, fill usecase=black!5, fill object=black!5}
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \umlbasiccomponent[x=5, y=1.5]{Plugins}
    \umlbasiccomponent[y=3]{Applications}
    \umlbasiccomponent{Framework}
...
\begin{figure}
  ...
  \begin{tikzpicture}
    \umlinterface[]{ViewHandler}{}{
      ...
      \umlvirt{+ getName() : String} \\
      \umlvirt{+ init(context : ServletContext)} \\
...
\verb=POST= n'a aucune de ces propriétés.
...
le méchanisme de Servlet.  Il était également question dans ce
...
HTTP servant à appeler un service et celle correspondant à un écran.
De ce fait il a semblé pertinent d'adapté la grammaire XML du
...
habitudes des développeurs OFBiz.
