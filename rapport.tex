...
\tikzumlset{fill class=black!5, fill component=white}
...
l'interface \verb=Container= représenté sur la figure  OFBiz ne définit par défault qu'un
seul container dans un fichier \verb=ofbiz-container.xml= et il est
